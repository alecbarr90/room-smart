...
const SmartestPersonApp = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black" style={{
      ...
      <header className="bg-gradient-to-r from-fuchsia-600 via-yellow-400 to-cyan-500 text-white p-6 text-center border-b-8 border-t-8 border-yellow-300" style={{boxShadow: "0 10px 0 #333"}}>
      ...
      <div className="p-6 max-w-4xl mx-auto w-full flex-grow">
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          <div className="bg-cyan-300 p-4 rounded-lg md:w-1/2 border-4 border-b-8 border-r-8 border-fuchsia-700" style={{boxShadow: "inset 2px 2px 10px white, inset -2px -2px 10px #666"}}>
          ...
          <div className="bg-fuchsia-300 p-4 rounded-lg md:w-1/2 border-4 border-b-8 border-r-8 border-cyan-700" style={{boxShadow: "inset 2px 2px 10px white, inset -2px -2px 10px #666"}}>
        ...
        <div className="bg-white rounded-lg mb-8 border-4 border-b-8 border-r-8 border-yellow-500" style={{
          ...
          <div className="p-4 bg-gradient-to-r from-yellow-300 via-fuchsia-300 to-cyan-300 rounded-t-lg border-b-4 border-yellow-500 text-center">
      ...
      {showScenarioModal && currentScenario && (
        ...
        >
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-cyan-400 via-fuchsia-300 to-yellow-300 z-10 border-b-4 border-purple-500">
      ...
      <footer className="bg-gradient-to-r from-purple-800 via-fuchsia-700 to-blue-800 text-white p-6 text-center border-t-8 border-yellow-300 relative">
